...
public class Config {
    ...
    public final int maxRequestsInProgress;
    ...
    public Config(Properties properties) {
        ...
        maxRequestsInProgress = Integer.parseInt(properties.getProperty("crawler.maxRequestsInProgress", "-1"));
    ...
    public String toString() {
        return "startUrl='" + startUrl + "'\n" +
                ...
                "maxRequestsInProgress=" + maxRequestsInProgress + "\n" +
